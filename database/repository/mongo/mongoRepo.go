...
func (repo *MongoRepository[T]) UpdateWithOperator(ctx context.Context, filter map[string]interface{}, payload map[string]interface{}, opts ...*options.UpdateOptions) (bool, error) {
	var cancel context.CancelFunc
	if ctx == nil {
		c, ctxCancel := repo.createCtx()
		ctx = c
	...
	_, err := repo.Model.UpdateOne(ctx, filter, payload, opts...)
	if err != nil {
...
func (repo *MongoRepository[T]) UpdateManyWithOperator(ctx context.Context,  filter map[string]interface{}, payload map[string]interface{}, opts ...*options.UpdateOptions) (int64, error) {
	var cancel context.CancelFunc
	if ctx == nil {
		c, ctxCancel := repo.createCtx()
		ctx = c
	...
	affected, err := repo.Model.UpdateMany(ctx, filter, payload, opts...)
	if err != nil {
